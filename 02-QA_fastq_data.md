...
- [Trim adapters and low quality bases](#trim-adapters-and-low-quality-bases)
- [Download files from the server](#download-files-from-the-server)
...
Not all the information here is relevant for us today. But look at the information in "Basic Statistics", "Per base sequence quality" and "Adapter Content".
